function [freqs,sigfreqs,sigpowers,variance,n]=lombscargle(inputdata,dupe_elim)
...
global cal calamp calfreq creationdate dataid datamatrix effm ep fhi freqs hifac info jmax lines n ...
	nmax nout np nuhifac ofac prob px py reg regnum s sigfreqs sigpowers variance tmax tmin win wintype x y  %%%%aik variance eklendi.
...
if ~isempty(freqs)
    ...
    format short g; save freqs.dat freqs -ascii;
